...
#define SPI0_REGISTERS_LEN (0x0018/4)
#define UART1_SPI1_SPI2_REGISTERS_LEN (0x00D8/4)
...
AUX_SPI1_STAT_REG   =   0xC8,
reserved            =   0xCC,
AUX_SPI1_IO_REG     =   0xD0,
AUX_SPI1_PEEK_REG   =   0xD4,
} SPI0Registers;
...
typedef struct max1246_spi_s{
    ...
    float CHX[4];
    int ch;
    uint32_t registers[SPI0_REGISTERS_LEN];
    //qemu_irq irq;
